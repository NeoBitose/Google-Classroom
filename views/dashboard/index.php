...
<body>
  <div class="topbar">
    ...
    <div class="rightbar">
      <div class="right-icon">
        ...
        <img class="grid" src="/uts/views/asset/img/grid-dot.svg" alt="">
        <img class="profile-img" src="/uts/views/asset/img/pp.png" alt="">
      </div>
    </div>
  </div>
  ...
  <div class="sidebar">
    <div class="nav">
        ...
        <li class="active">
          <div class="nav-link-group">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path
                d="M3.00034 9L12.0003 2L21.0003 9V20C21.0003 20.5304 21.0003 21.5 21.0003 22C20.5003 22 19.5308 22 19.0003 22H5.00034C4.46991 22 3.5 22 3 22C3 21.5 3.00034 20.5304 3.00034 20V9Z"
      ...
      <ul>
        <li class="accordion">
          <svg focusable="false" width="24" height="24" viewBox="0 0 24 24" class="arrow-li">
          ...
          <li class="">
            <div class="nav-link-group">
              <svg enable-background="new 0 0 24 24" focusable="false" height="24" viewBox="0 0 24 24" width="24"class=" NMm5M">
                <g><path d="M20,6h-8l-2-2H4C2.9,4,2.01,4.9,2.01,6L2,18c0,1.1,0.9,2,2,2h16c1.1,0,2-0.9,2-2V8C22,6.9,21.1,6,20,6z M20,18H4V8h16V18z M18,12H6v-2h12V12z M14,16H6v-2h8V16z"></path>
      ...
      <ul>
        <li class="">
          <div class="nav-link-group">
            <svg stroke-width="0" focusable="false" width="24" height="24" viewBox="0 0 24 24" class=" NMm5M">
              <path
